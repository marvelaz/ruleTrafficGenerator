...
cd /home/labadmin/tools
source .venv/bin/activate
python3 main.py analyze --traditional --skip-unused 2>&1 | grep -E "Total lab|Used|Unused|Zero"
```
...
> **Why `--skip-unused` here?** This flag runs only the behavioral hit-count check without the full CIDR structural analysis — Lab 3 does the full analysis. It gives you a quick count of which rules have traffic without the longer structural scan output.
